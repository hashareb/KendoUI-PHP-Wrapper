...
class DataSourceResult {
    ...
    public function addFilterToRequest($field, $value, $request) {
        $filter = (object) array(
                    'logic' => 'and',
                    'filters' => array(
                        (object) array(
    ...
    public function addFilter($type, $array, $request) {
        $filter = (object) array(
                    'logic' => $type,
                    'filters' => $array
        );
    ...
    public function addExternalFilterToRequest($filters_array, $type) {
        $filter = array(
                    'logic' => $type,
    ...
    public function ObjectsFilter($field,$operator,$value) {
        return (object) array(
                    'field' => $field,
                    'operator' => $operator,
                    'value' => $value
